            ...
            <div class="login-card ">
                ...
                <form action="" method="post" class="login-form">
                    <div class="form-group">
                        ...
                        <input type="email" id="login-email" name="email" placeholder="alex.morgan@example.com" autocomplete="email" required>
                    </div>
                    ...
                    <a class="forgot-password" href="forgot-password.php">Forgotten your password?</a>

                </form>
                <button type="submit" class="login-submit">Log in <span aria-hidden="true"><img src="./img/arrow-right.svg" alt=""></span></button>

                <p class="login-signup">New here? <a href="signup.php">Create an account</a></p>
            </div>
        </div>
  </section>
