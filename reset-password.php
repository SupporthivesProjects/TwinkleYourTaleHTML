            ...
            <div class="login-card" id="login-card">
                ...
                <form action="" method="post" class="login-form">
                    <div class="from-group">
                        <p class="form-group-para" id="form-group-para">Choose a new password for alex.morgan@example.com.</p>
                    </div>
                    <div class="form-group">
                        <label for="login-email">New password</label>
                        <input type="email" id="login-email" name="email" placeholder="New password" autocomplete="email" required>
                    </div>

                    <div class="form-group">
                        <label for="login-password">Confirm new password</label>
                        <input type="password" id="login-password" name="password" placeholder="Confirm new password" autocomplete="current-password" required>
                    </div>


                </form>
                <button type="submit" class="login-submit">Update password <span aria-hidden="true"><img src="./img/arrow-right.svg" alt=""></span></button>
            </div>
        </div>
  </section>
