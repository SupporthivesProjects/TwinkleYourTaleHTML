            ...
            <div class="login-card " id ="login-card">
                ...
                <form action="" method="post" class="login-form">
                    <div class="from-group">
                        <p class="form-group-para" id="form-group-para">Its easy to do and free, then you can start creating your first story!.</p>
                    </div>
                    <div class="form-group">
                        <label for="login-email">Your name</label>
                        <input type="email" id="login-email" name="email" placeholder="Alex" autocomplete="email" required>
                    </div>
                    ...
                    <div class="signup-terms">
                        <label class="checkbox-wrap" for="agree-terms">
                            <input type="checkbox" id="agree-terms" name="agree_terms" required>
                            <span class="checkmark" aria-hidden="true"></span>
                            <span class="checkbox-text">I agree to the Terms &amp; Conditions and the Privacy Policy.</span>
                        </label>
                    </div>

                    <div class="captcha-box" aria-label="Captcha verification">
                        <div class="captcha-image">
                            <img src="./img/captcha-checkbox.png" alt="Captcha security check">
                        </div>
                    </div>

                </form>
                <button type="submit" class="login-submit">Create account <span aria-hidden="true"><img src="./img/arrow-right.svg" alt=""></span></button>

                <p class="login-signup">Already have an account?<a href="login.php">Log in</a></p>
            </div>
        </div>
  </section>
